...
##Add income column to the user table- 
alter table user_details add column income double;
alter table card_details add column name_of_card varchar(30);
alter table user_transaction_user_id_1 modify column transaction_type enum('Credit', 'Debit');
